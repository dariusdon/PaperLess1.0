    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p style=" margin-left:80px; border-width:4px; width: 1572px;">
                ...
                <asp:Button ID="Button5" runat="server" Text="Editeaza Rand" Font-Size="20px" OnClick="Button5_Click" Width="171px"/>
                <br/>
                <br/>
            </p>
         ...
         <PagerStyle backcolor="#ffa500"
          ...
          horizontalalign="Right"/>
             <Columns>
                  ...
                  <asp:CommandField ButtonType="Image" DeleteImageUrl= "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThjl7mlwlpu7GjhxWZhtQIHCVajZN9Hh1FMGXeBRu5_OQBsnTgmE5t74V03FPuN5SQQ7E&usqp=CAU" ControlStyle-Width="25" ShowDeleteButton="true" HeaderText ="Delete" CancelText="true"/>
